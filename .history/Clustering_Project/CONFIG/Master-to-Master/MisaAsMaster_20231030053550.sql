...
-- subscription
create subscription sub_misa_server_dylan_clustering_project connection 'dbname = clustering_project host = 192.168.43.8 user = clustering_project password = clustering_project ' publication pub__clustering_project ;