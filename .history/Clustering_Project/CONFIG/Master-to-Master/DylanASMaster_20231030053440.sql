...
-- subscription
create subscription sub_dylan_server_misa connection 'dbname = clustering_project host = 192.168.43.8 user = clustering_project password = clustering ' publication pub_misa ;