...
-- subscription
create subscription sub_dylan_server_misa_clustering_project connection 'dbname = clustering_project host = 192.168.43.8 user = clustering_project password = clustering_project ' publication pub_misa ;