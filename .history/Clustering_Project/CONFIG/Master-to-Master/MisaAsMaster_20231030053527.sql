...
create publication pub_dylan for table session where (server_id ='server_misa');

-- subscription
create subscription sub_misa_server_misa_clustering_project connection 'dbname = clustering_project host = 192.168.43.8 user = clustering_project password = clustering_project ' publication pub_misa_clustering_project ;