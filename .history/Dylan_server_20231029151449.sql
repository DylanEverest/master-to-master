...
create publication pub_dylan_alain for table server where (server_id ='server_alain');
create publication pub_dylan_misa for table server where (server_id ='server_misa');