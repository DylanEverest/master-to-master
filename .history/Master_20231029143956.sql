...
create publication pub_server_alain
create publication pub_server_misa
create publication pub_server_dylan
...
create publication pub_server_dylan for table server where (server_id ='server_dylan');
